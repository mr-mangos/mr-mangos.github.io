class egpObjectBox extends egpObject{

  constructor(Index){
    
    super(Index);
    
    this.set_propertie("name", "Box");
  ...
  getE2Line(){
    ...
    C += 'Egp:egpBox(' + this.get_propertie("index") + ', vec2(' + this.get_propertie("posx") + ', ' + this.get_propertie("posy") + '), vec2(' + this.get_propertie("sizex") + ', ' + this.get_propertie("sizey") + ')) ';
  ...
  render(){
    ...
    rectMode(CENTER);
    rect(0, 0, this.get_propertie("sizex"), this.get_propertie("sizey"));
